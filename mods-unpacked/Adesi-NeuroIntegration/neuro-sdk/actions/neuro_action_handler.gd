...
func _notification(what):
	if what == NOTIFICATION_WM_QUIT_REQUEST:
		...
		get_tree().root.get_node("/root/ModLoader/Adesi-NeuroIntegration/WebsocketNode").send_immediate(load("res://mods-unpacked/Adesi-NeuroIntegration/neuro-sdk/messages/outgoing/actions_unregister.gd").new(array))
...
func register_actions(actions: Array): # [NeuroAction]
	...
	for action in actions:
		array.append(action.get_ws_action())
	get_tree().root.get_node("/root/ModLoader/Adesi-NeuroIntegration/WebsocketNode").send(load("res://mods-unpacked/Adesi-NeuroIntegration/neuro-sdk/messages/outgoing/actions_register.gd").new(array))
...
func unregister_actions(actions: Array): # [NeuroAction]
	...
	for action in actions_to_remove:
		array.append(action.get_ws_action())
	get_tree().root.get_node("/root/ModLoader/Adesi-NeuroIntegration/WebsocketNode").send(load("res://mods-unpacked/Adesi-NeuroIntegration/neuro-sdk/messages/outgoing/actions_unregister.gd").new(array))
...
static func get_instance():
	return Utils.get_tree().root.get_node("NeuroActionHandlerNode")