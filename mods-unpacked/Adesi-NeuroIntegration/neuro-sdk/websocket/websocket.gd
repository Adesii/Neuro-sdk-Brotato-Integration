...
var _message_queue = load("res://mods-unpacked/Adesi-NeuroIntegration/neuro-sdk/websocket/message_queue.gd").new()
...
func _enter_tree() -> void:
	_command_handler = load("res://mods-unpacked/Adesi-NeuroIntegration/neuro-sdk/websocket/command_handler.gd").new()
...
static func get_instance():
	return Utils.get_tree().root.get_node("WebsocketNode")
