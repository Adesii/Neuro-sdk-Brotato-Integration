...
func _ready():
	...
	action_window.add_action(Utils.InfoAction.new(null, self, "character"))
	action_window.set_context("Its time to select a character you want to play. each Character has Unique statitics that can be used to guide your playstyle.", true)
